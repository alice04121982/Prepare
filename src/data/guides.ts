...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      "If someone at home relies on powered medical equipment (home dialysis, oxygen, a ventilator, a feeding pump) or medicine kept in a fridge (insulin, some injections), a power cut or water outage can become urgent within hours or days.",
      "Your plan needs three things: how long treatment can safely wait, a backup power source, and a list of who to call, starting with your healthcare team.",
    ],
    stepsTitle: "what to do now",
    steps: [
      { title: "Ask your healthcare team three questions", body: "How long can treatment or medication safely be delayed? What is the earliest sign something is wrong? Where would you go if your usual unit lost power or water?" },
      ...
      { title: "Know the warning signs", body: "Ask your healthcare team what symptoms mean you need help right now, not tomorrow. Know the phone numbers for NHS 111 (urgent), 999 (emergency), and your GP." },
      { title: "Look at backup power now", body: "A battery backup or portable power station can keep equipment running for a while; check how many watts it needs. A generator must only run outdoors, away from windows. Never run a car in a garage to charge anything." },
      { title: "Keep a week of medicines in hand", body: "Order repeat prescriptions about a week before you run out, so there is always a week spare. If you do run out, a pharmacist can sometimes give an emergency supply. Store medicines somewhere cool and dry, not the bathroom." },
      { title: "Make a card with your medical information", body: "Your condition, current medicines, allergies, NHS number, who to call and your nearest hospital. Carry it with you and keep a copy at home." },
    ],
    warning: {
    ...
    ready: [
      { item: "Backup power for equipment", tip: "A battery backup (UPS) or portable power station. A generator only if it can run outdoors, away from windows.", search: "uninterruptible power supply UPS" },
      { item: "Medical summary card", tip: "Your condition, medicines, allergies and emergency contacts, to carry with you.", search: "medical alert card holder" },
      { item: "Extra supply of medications", tip: "Order repeat prescriptions early so there is always a week in hand.", search: "medication storage box" },
      { item: "Thermos or cool box", tip: "If medicine needs to stay cool and the fridge is off, a cool box buys time. Keep insulin off direct contact with ice packs: it must not freeze.", search: "medical cool box insulin" },
    ],
    sources: [
      ...
      { label: "How to get an emergency supply of medicine", publisher: "NHS", url: "https://www.nhs.uk/nhs-services/pharmacies/how-to-get-an-emergency-supply-of-medicine/" },
    ],
    checked: "2026-09-25",
    verified: false,
  ...
  },
  {
    ...
    description:
      "Haemodialysis depends on power and clean water. Ask your unit for its outage plan now, and register for priority help.",
    answer: [
      "This is preparedness guidance, not medical advice. Talk to your dialysis unit and kidney doctor now about what happens in a power cut or water outage. See the medical disclaimer for what this means.",
      "Haemodialysis is usually needed 3 times a week. Missing a session can be dangerous, because potassium and fluid build up in the body. Your unit will have a plan for outages: ask for it now.",
      "Peritoneal dialysis does not use mains water. If you use a machine overnight, ask your team how to switch to manual exchanges if the power goes off.",
    ],
    stepsTitle: "what to do now",
    steps: [
      ...
      { title: "Ask your dialysis unit their backup plan", body: "Which unit would you go to if yours closed? Who calls you if a session moves? If you dialyse at home, what should you do in a power cut or water outage?" },
      { title: "Keep your medical history written down", body: "Your condition, medicines, allergies, fistula or line side, and your unit's phone number. A copy in your bag and one at home." },
      { title: "Ask about an emergency diet", body: "Your unit can give you a diet and fluid limit to follow if a session is delayed. It slows the build-up of potassium and fluid. Keep it with your medical card." },
      { title: "Know when to call 999", body: "Chest pain, a very fast, slow or irregular heartbeat, severe breathlessness or sudden weakness: call 999 and say you are on dialysis." },
      { title: "Keep a few days of medications at home", body: "Order repeat prescriptions early so there is always a week in hand." },
    ],
    warning: {
      title: "Do not miss a session without talking to your unit",
      body: "If a session is cancelled, your unit should arrange another. If you cannot reach them, call NHS 111. Chest pain or a very irregular heartbeat: call 999.",
    },
    ready: [
      { item: "Medical summary card", tip: "Your condition, medicines, allergies and unit's number, to carry with you.", search: "medical alert card holder" },
      { item: "Prescribed medications kept at home", tip: "Order repeat prescriptions early so there is always a week in hand.", search: "medication storage box" },
    ],
    sources: [
      { label: "Dialysis", publisher: "NHS", url: "https://www.nhs.uk/conditions/dialysis/" },
      { label: "Help and support for kidney patients", publisher: "Kidney Care UK", url: "https://www.kidneycareuk.org/" },
    ],
    checked: "2026-09-25",
    verified: false,
