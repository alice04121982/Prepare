...
export function Counter({
  ...
  const step =
    "grid h-11 w-11 place-items-center rounded-[4px] border-2 border-ink bg-paper text-ink hover:bg-[var(--hover)] disabled:cursor-not-allowed disabled:border-ink/30 disabled:text-ink/30 disabled:hover:bg-paper";
  return (
