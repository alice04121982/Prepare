...
export default function PageIntro({ eyebrow, title, lede, aside }: Props) {
  return (
    <div className="mb-12 rounded-card bg-mint px-6 py-10 sm:px-10 sm:py-14">
      <div className="grid items-center gap-8 md:grid-cols-[1.4fr_1fr]">
        <div>
          ...
          <h1 className="text-4xl font-normal leading-[1.08] text-forest sm:text-5xl">
            {title}
          </h1>
        ...
        {aside ? <div className="justify-self-center md:justify-self-end">{aside}</div> : null}
      </div>
    </div>
  );
}
